    ...
    <nav className="gradient-bg px-8 py-4 shadow-lg sticky top-0 z-50">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <div className="flex items-center">
          <Link to="/" className="flex items-center text-white font-semibold text-xl transition-transform duration-300 hover:scale-105">
        ...
        <div className={`flex gap-8 items-center transition-all duration-300 ${
          isMenuOpen 
        ...
        <button 
          ...
          aria-label="切换菜单"
        >
          <span className={`w-6 h-0.5 bg-white mb-1.5 rounded transition-all duration-300 ${
